...
import EditUserForm from './Dialog/edit-User-form';
import DeleteUserForm from './Dialog/delete-user-form';
...
export default function DataTableRowActions<TData extends WithId<string>>({
  ...
  const nom = row.original.nom as string;
  ...
  return (
    <>
      ...
      >
        <EditUserForm cardId={cardId} setIsOpen={setIsEditOpen} />
      </ResponsiveDialog>
      ...
      >
        <DeleteUserForm cardId={(cardId+"")} nom={nom} setIsOpen={setIsDeleteOpen} />
      </ResponsiveDialog>
