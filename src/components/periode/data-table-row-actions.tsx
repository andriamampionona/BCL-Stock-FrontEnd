...
import EditFormPeriode from './Dialog/edit-form';
import DeleteFormPeriode from './Dialog/delete-form';
...
export default function DataTableRowActions<TData extends WithId<string>>({
  ...
  const title = row.original.designation as string;
  ...
  return (
    <>
      ...
      >
        <EditFormPeriode cardId={cardId} setIsOpen={setIsEditOpen} />
      </ResponsiveDialog>
      ...
      <ResponsiveDialog
        ...
        title={title}
      >
        <DeleteFormPeriode cardId={parseFloat(cardId)} setIsOpen={setIsDeleteOpen} />
      </ResponsiveDialog>
